...
group('Fn()', function(test, log) {
	...
	test('Fn.from(array)', function(equals) {
		var fr = Fn.from([6]);
		equals(6, fr.shift());
		equals('done', fr.status);
		equals(undefined, fr.shift());

		var fr = Fn.from([0, 'lamb', true, false]);
		equals(0, fr.shift());
		...
		var fr = Fn.from([undefined, true, false]);
		equals(true, fr.shift());
		equals(false, fr.shift());
		equals('done', fr.status);
		equals(undefined, fr.shift());

		var fr = Fn.from([true, undefined, false]);
		equals(true, fr.shift());
		equals(false, fr.shift());
		equals('done', fr.status);
		equals(undefined, fr.shift());

		var fr = Fn.from([true, null, false]);
		equals(true, fr.shift());
