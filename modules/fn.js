...
(function(window) {
	...
	export function args() { return arguments; }

	export function id(object) { return object; }

	export function self() { return this; }

	export function call(value, fn) {
		return fn(value);
	}
	...
	export function compose(fn2, fn1) {
	...
	export function toClass(object) {
	...
	export function Timer(duration, getTime) {
	...
	export function Throttle(fn, request, cancel) {
